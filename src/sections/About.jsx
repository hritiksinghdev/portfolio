    ...
    <section id="about" className="c-space section-spacing">
      ...
      >
        ...
        >
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi I'm Hritik</p>
            <p className="subtext">
              Actively developing my frontend and backend skills by building dynamic, 
              production-style websites using modern tools and deployment practices.
            </p>
          </div>
          <div
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I am currently based in INDIA, and open to work
            </p>
          </div>
